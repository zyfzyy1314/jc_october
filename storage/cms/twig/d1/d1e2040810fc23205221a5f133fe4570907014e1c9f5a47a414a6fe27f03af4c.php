...
/* /Users/kekaiwang/Sites/jc_october/themes/demo/pages/home.htm */
class __TwigTemplate_1644f60503adfb7a36822ce10461c59d303e41c27cb7380c5a7c95a1a30d804e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
    ...
    <p>
        ...
        everything that repeats on each page, such as the HTML, HEAD and BODY tags, StyleSheet and JavaScript
        references.
    </p>
    ...
    <p>
        The page file <code>pages/home.htm</code> defines the page URL (<code>/</code> for this page) and the page
        content.
    ...
    <pre>";
        ...
        echo "</pre>
    <p>You may place partials inside folders too. In this example we placed the footer content to the
        <code>partials/site/footer.htm</code> partial.</p>
    <pre>";
        // line 59
    ...
    <p class=\"lead\">
        <i class=\"icon-font\"></i> &nbsp; Content blocks are text or HTML blocks that can be edited separately from the
        page or layout.
    </p>
    <p>
    ...
    <p>
        The common use is injecting page-specific links to StyleSheet or JavaScript files to the HEAD tag defined in the
        layout.
    ...
    <p>This theme stores its asset files (JavaScript, StyleSheet, images, fonts, etc) in the
        <code>themes/demo/assets</code> directory. This theme is also packaged with these useful 3rd party tools:</p>
    ...
    {
        return "/Users/kekaiwang/Sites/jc_october/themes/demo/pages/home.htm";
    }
    ...
    {
        return array (  184 => 119,  156 => 96,  147 => 92,  125 => 73,  108 => 59,  102 => 56,  85 => 42,  45 => 4,  41 => 3,  37 => 1,);
    }
...
</div>", "/Users/kekaiwang/Sites/jc_october/themes/demo/pages/home.htm", "");
    }
}
